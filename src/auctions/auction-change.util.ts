...
export const AUCTION_FIELD_LABELS: Record<string, string> = {
  ...
  builtYear: "연식",
  vatPnu: "부가세계산 PNU",
  vatStructureName: "부가세계산 구조명",
  vatMainPurposeName: "부가세계산 주용도명",
  vatGroundFloors: "부가세계산 지상층수",
  bidDate: "입찰기일",
  appraisedValue: "감정가",
  minPrice: "최저가",
  salePrice: "낙찰가",
  ...
  tenantInfo: "임차정보",
  specialNote: "특이사항",
  unpaidFeeAmount: "체납금액(관리비)",
  unpaidFeeNote: "체납조사 비고",
  unpaidFeeCheckedAt: "체납조사일",
  elevator: "승강기",
  parking: "주차장",
  landShare: "토지지분",
