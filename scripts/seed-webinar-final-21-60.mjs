/**
 * 최종본 웨비나 슬라이드 21~60 시드 (sql.js 로컬 DB 전용).
 * 사용: node seed-webinar-final-21-60.mjs
...
const rows = [
  ...
  { id: "webinar-final_slide-23", sortOrder: 22, label: "23. 첫 투자 계획(대치아이파크)", content: { headerTitle: "저는 누구일까요?", label: "첫 투자 계획", title: "대치아이파크", l1: "매매 10억", l2: "전세 7억", "l3::prefix": "투자", "l3::highlight": "3억" } },
  { id: "webinar-final_slide-24", sortOrder: 23, label: "24. 명랑時代 쌀핫도그", content: { headerTitle: "저는 누구일까요?", title: "명랑時代", "l2::tag": "쌀", "l2::suffix": "핫도그" } },
  { id: "webinar-final_slide-25", sortOrder: 24, label: "25. 얼마가 되었을까요?", content: { title: "얼마가 되었을까요?" } },
  { id: "webinar-final_slide-26", sortOrder: 25, label: "26. 10억->23억", content: { l1: "10억 -> 23억", l2: "5년 13억", l3: "연 2.6억", l4: "월 2천만원", l5: "현재 32억(22억 수익)" } },
  ...
  { id: "webinar-final_slide-30", sortOrder: 29, label: "30. 5년 만에 5천으로 4.5억 수익", content: { headerTitle: "경매를 찾아서", l1: "5년 만에<br>5천 으로", highlight: "4.5억 수익" } },
  { id: "webinar-final_slide-31", sortOrder: 30, label: "31. 답은 부동산이군 경매가 좋다고?", content: { l1: "답은 부동산이군", l2: "경매가 좋다고?", caption: "기웃기웃" } },
  ...
  { id: "webinar-final_slide-36", sortOrder: 35, label: "36. 처음부터 성공했던건 아니었습니다", content: { l1: "물론,<br>저도 처음부터", "line::l2a": "성공했던건", l2b: "아니었습니다." } },
  { id: "webinar-final_slide-37", sortOrder: 36, label: "37. 수강료만 2000만원", content: { l1: "수강료만", highlight: "2000만원" } },
  { id: "webinar-final_slide-38", sortOrder: 37, label: "38. 아파트x아파트 6개월동안 패찰", content: { banner: "6개월동안 패찰" } },
  { id: "webinar-final_slide-39", sortOrder: 38, label: "39. 아파트 -> 빌라 방향전환", content: { l1: "아파트", l2: "빌라", title: "방향전환" } },
  { id: "webinar-final_slide-40", sortOrder: 39, label: "40. 낙찰을 받기 시작하였습니다", content: { title: "낙찰을 받기 시작하였습니다" } },
  {
    id: "webinar-final_slide-41", sortOrder: 40, label: "41. 낙찰사례 - 시흥동 해비치빌",
    content: {
  ...
  {
    id: "webinar-final_slide-42", sortOrder: 41, label: "42. 낙찰사례 - 화곡동 동양하우징",
    content: {
      headerTitle: "낙찰을 받기 시작하였습니다!",
  ...
  {
    id: "webinar-final_slide-43", sortOrder: 42, label: "43. 낙찰사례 - 순월세350",
    content: {
      headerTitle: "낙찰을 받기 시작하였습니다!",
  ...
  {
    id: "webinar-final_slide-44", sortOrder: 43, label: "44. 낙찰사례 - 3억싸게",
    content: {
      headerTitle: "낙찰을 받기 시작하였습니다!",
      table: "오늘:1&nbsp;&nbsp;누적:468&nbsp;&nbsp;평균(2주):0<br>2024-11-25 1,215,738,320 변경<br>1차 2025-05-27 1,215,738,320<br>매각 1,230,099,999원 (101.18%) / 입찰 1명 / 주〇〇〇<br>매각결정기일 : 2025-06-04",
      summary: "시세 15억/ 낙찰 12억(3억싸게)",
    },
  },
  {
    id: "webinar-final_slide-45", sortOrder: 44, label: "45. 낙찰사례 - 6억싸게",
    content: {
      headerTitle: "낙찰을 받기 시작하였습니다!",
  ...
  { id: "webinar-final_slide-48", sortOrder: 47, label: "48. 카톡대화 - 4.5정도 잡으면", content: { caption: "카톡 대화: 시세 분석과 입찰가 산정 과정" } },
  { id: "webinar-final_slide-49", sortOrder: 48, label: "49. 카톡대화 - 700만원차이 낙찰", content: { caption: "카톡 대화: 낙찰 소식 전달" } },
  { id: "webinar-final_slide-50", sortOrder: 49, label: "50. 60대 아버님 낙찰 후기", content: { title: "60대 아버님", l1: "낙찰", l2: "또 낙찰" } },
  { id: "webinar-final_slide-51", sortOrder: 50, label: "51. 50대/30대 낙찰 성공 후기", content: { l1: "50대 아버님<br>7주 만에<br>낙찰 성공!", l2: "30대 직장인<br>10주 만에<br>낙찰 성공!" } },
  ...
  { id: "webinar-final_slide-55", sortOrder: 54, label: "55. 수강생 성과_비규제지역_대출90%", content: { headerTitle: "수강생 성과_비규제지역_대출90%", label: "비규제빌라", info: "시세: 1.9억<br>낙찰: 1.38억(대출90%)<br>투자 : 1.4천<br>수익: 5천" } },
  { id: "webinar-final_slide-56", sortOrder: 55, label: "56. 수강생 성과_비규제지역_동시낙찰", content: { headerTitle: "수강생 성과_비규제지역_동시낙찰_대출90%", label: "비규제빌라(동시)", info: "대출90%<br>투자A/B : 1.3천/2.1천<br>수익A/B: 4천 / 4천" } },
  { id: "webinar-final_slide-57", sortOrder: 56, label: "57. 수강생 성과_다세대주택_규제전", content: { headerTitle: "수강생 성과_다세대주택_규제전", info: "시세: 2.8억<br>낙찰: 1.7억(대출90%)<br>투자: 2천<br>수익: 1억" } },
  { id: "webinar-final_slide-58", sortOrder: 57, label: "58. 수강생 성과_비규제지역_빌라_공시가1억미만", content: { headerTitle: "수강생 성과_비규제지역_빌라_공시가1억미만", label: "비규제빌라(1주택자)", info: "시세: 1.4억<br>낙찰: 1억(대출80%)<br>투자 : 2천<br>수익: 4천" } },
  { id: "webinar-final_slide-59", sortOrder: 58, label: "59. 수강생 성과_비규제지역_아파트_90%", content: { headerTitle: "수강생 성과_비규제지역_아파트_90%", label: "비규제아파트", info: "시세: 3.4억<br>낙찰: 2.8억(대출90%)<br>투자 : 3천<br>수익: 6천" } },
  { id: "webinar-final_slide-60", sortOrder: 59, label: "60. 수강생 성과_비규제지역_아파트_무주택", content: { headerTitle: "수강생 성과_비규제지역_아파트_90%", label: "비규제아파트(무주택)", info: "시세: 4억<br>낙찰: 3.3억(대출90%)<br>투자 : 3.3천<br>임차후투자 : 300만원<br>(3000/150)<br>수익: 7천" } },
];
